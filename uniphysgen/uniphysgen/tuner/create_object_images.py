...
def copy_img_per_entity(entity_dir, save_dir, sample_points=100000):
    img_dir = os.path.join(entity_dir, "views")
    if not os.path.exists(img_dir):
        return
    save_img_dir = os.path.join(save_dir, "views")
    if os.path.exists(save_img_dir) and len(os.listdir(save_img_dir)) == 8:
        return
...
if __name__ == '__main__':
    ...
    # a = 1
    res_roots = {
        "abo": "/seaweedfs/xianzi//abo-3dmodels_render/abo-3dmodels/",
        "partnet": "/seaweedfs/xianzi/data/partnet_render/",
        "objaverse": "/seaweedfs/xianzi/data/phys_objaverse_sketchfab_trellis_render/",
        "hssd": "/seaweedfs/xianzi/data/hssd_render/",
        "future": "/seaweedfs/xianzi/data/future_render"
    }
