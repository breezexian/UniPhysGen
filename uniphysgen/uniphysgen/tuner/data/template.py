...
if TYPE_CHECKING:
    ...
    from .mm_plugin import SpatialLMPlugin, PhysMeshLLMPlugin
...
def register_template(
        ...
        mm_plugin: object = get_mm_plugin(),
        cutoff_len: int = 8192,
) -> None:
...
def register_physmeshllm_templates(
        cutoff_len: int = 8192,
        num_bins: int = 400,
    ...
    register_template(
        ...
        mm_plugin=get_mm_plugin(
            ...
            use_spherical_axis=use_spherical_axis,
            random_xyz_rotation=random_xyz_rotation,
            share_grid_origin=share_grid_origin,
        ),
        cutoff_len=cutoff_len,
    )
