...
class DatasetAttr:
    ...
    task_name: Optional[str] = "physics"
    # extra configs
    ...
    object_info: Optional[str] = "object_level"
    part_info: Optional[str] = "part_info"
    basic_info: Optional[str] = "basic_info"
    kinematic_info: Optional[str] = "kinematic_info"
    ...
    def join(self, attr: dict[str, Any]) -> None:
        ...
        self.set_attr("task_name", attr)
        self.set_attr("use_image", attr)
        if "columns" in attr:
            column_names = [
                "prompt",
                "query",
