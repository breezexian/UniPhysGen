...
class DataArguments:
    ...
    random_xyz_rotation: bool = field(
        default=False,
        metadata={"help": "Whether or not to do non axis random choice."},
    )
    use_spherical_axis: bool = field(
        default=False,
        metadata={"help": "Whether or not to use spherical_axis."},
    )
    share_grid_origin: bool = field(
        default=True,
        metadata={"help": "Whether or not to use share_grid."},
    )
