...
if __name__ == '__main__':
    """
    tar -czf new_example.tar.gz /seaweedfs/xianzi/data/abo-3dmodels_res/1/B07H8SZP51 /seaweedfs/xianzi/data/abo-3dmodels_res/7/B072ZK8897 /seaweedfs/xianzi/data/abo-3dmodels_res/7/B075X12K17 /seaweedfs/xianzi/data/abo-3dmodels_res/7/B08DW4FPM7 /seaweedfs/xianzi/data/abo-3dmodels_res/8/B07B7DL3H8 /seaweedfs/xianzi/data/abo-3dmodels_res/8/B07HSJJVD8 /seaweedfs/xianzi/data/abo-3dmodels_res/8/B07R3X38R8 /seaweedfs/xianzi/data/abo-3dmodels_res/8/B082L28P18
    """
        ...
        for type_name in tqdm(type_names):
            ...
            with ProcessPoolExecutor(max_workers=20) as executor:
                ...
                for future in as_completed(futures):
                    ...
                    print(future.result())
    # json_pth = "/seaweedfs/xianzi/data/a_physllm/physllm_physics_train.json"
    # dt = json.load(open(json_pth, "r"))
    # for part in dt:
    #     part_label = part["index"]["label"]
    #     # part["object_level"]["object_ply"] = "/seaweedfs/xianzi/data/abo-3dmodels_res/0/B00BBDF500/plys/model.ply"
    #     # part["part_level"]["part_ply"] = f"/seaweedfs/xianzi/data/abo-3dmodels_res/0/B00BBDF500/plys/{part_label}.ply"
    #     part["object_level"]["object_ply"] = "/seaweedfs/xianzi/data/abo-3dmodels_res/0/B00BBDF500/npzs/model.npz"
    #     part["part_level"]["part_ply"] = f"/seaweedfs/xianzi/data/abo-3dmodels_res/0/B00BBDF500/npzs/{part_label}.npz"
    # print(dt)
    # json.dump(dt, open(json_pth, "w"), indent=4)
    # assert 1 == 2
