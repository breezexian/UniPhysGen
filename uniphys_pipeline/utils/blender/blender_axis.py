...
for file in os.listdir(model_dir):
    if file.endswith(".obj"):
        if "ori" not in file and "part" not in file:
...
# 识别主模型（非 axis 对象）
main_objs = [o for o in objs if "axis" not in o.name.lower()]
axis_names = [o.name for o in objs if "axis" in o.name.lower()]
